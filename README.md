...
## How to Import a Solution into Power Automate
...
Step 2: Navigate to Solutions
	...
	2.	If you don’t see the Solutions option, click on the Expand icon to reveal more options.

Step 3: Import the Solution

	1.	In the Solutions page, click on the Import Solution button located at the top.
	2.	A new pane will appear. Click on the Browse button to locate your solution file.
	3.	Select the solution file (.zip) from your computer.
	4.	Click on Next.

Step 4: Review and Import

	1.	The solution details will be displayed. Review the information to ensure it’s correct.
	2.	Click on Import.
	3.	Wait for the import process to complete. This may take a few moments.

Step 5: Confirm the Import

	1.	Once the import is complete, you will see a confirmation message.
	2.	Your solution will now be listed in the Solutions page.

## About Autenti E-Signature Workflow Connector for Power Automate

## Prerequisites

- An account on the Autenti platform.
- OAuth application configuration in Autenti to obtain `clientId` and `clientSecret`. To get your `clientId` and `clientSecret` send email to [Autenti sales](mailto:sales@autenti.com)
